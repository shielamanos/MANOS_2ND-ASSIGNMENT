...
#======================================== FRAMES AND LABELS =======================================#
    ...
    headlabel = Label(root, text="", bg="pink", fg="white", font=("Arial", 30, "bold"), anchor="center")
    headlabel.place(x=10, y=10, width=1180, height=50)
    
    studentroot = LabelFrame(root, bg='pink', text="    STUDENT DETAILS   ", fg="white", font=("Arial", 20, "bold"))
    courseroot = LabelFrame(root, bg='pink',  text="    COURSE DETAILS   ", fg="white", font=("Arial", 20, "bold"))
    displayroot = LabelFrame(root, bg='pink', font=("Arial", 20, "bold"))
    displayroot.place(x=470, y=80, height=400, width=720)
    
    slabel = Label(displayroot, bg="white", fg="white", font=("Arial", 12, "bold"), anchor="w")
...
#======================================== STUDENT LIST FEATURES =======================================#
        ...
        displayroot.config(text="    LIST OF STUDENTS   ", fg="white")
        ...
        addbut = Button(studentroot, text="ADD", command=addStudent, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
        updbut = Button(studentroot, text="UPDATE", command=updateStudent, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
        delbut = Button(studentroot, text="DELETE", command=deleteStudent, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
        clearbut = Button(studentroot, text="CLEAR", command=clear, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
...
#======================================== COURSE LIST FEATURES =======================================#
        ...
        addbut = Button(courseroot, text="ADD", command=addCourse, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
        updbut = Button(courseroot, text="UPDATE", command=updateCourse, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
        delbut = Button(courseroot, text="DELETE", command=deleteCourse, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
        clearbut = Button(courseroot, text="CLEAR", command=clear, font=("Arial", 14, "bold"), bg="violet", fg="white", activebackground="black", activeforeground="black")
        addbut.place(x=25, y=270, width=90, height=35)
        updbut.place(x=125, y=270, width=90, height=35)
        delbut.place(x=225, y=270, width=90, height=35)
        clearbut.place(x=325, y=270, width=90, height=35)
        ...
        searchbut = Button(displayroot, text="SEARCH", command=searchCourse, relief=FLAT, font=("Arial", 12, "bold"), bg="violet", fg="white", activeforeground="violet", activebackground="black")
        searchbut.place(x=305, height=30, y=15, width=80)
        refreshbut = Button(displayroot, text="VIEW ALL", command=lambda: [schccode.set(""), searchCourse()], relief=FLAT, font=("Arial", 12, "bold"), bg="violet", fg="white", activeforeground="violet", activebackground="black")
        refreshbut.place(x=390, height=30, y=15, width=80)
...
#========== BUTTONS ==========#
    ...
    studbutton = Button(command=student, text="STUDENTS", fg="white", bg="violet", font=("Arial", 18, "bold"), activebackground="white", activeforeground="white")
    coursebutton = Button(command=course, text="COURSES", fg="white", bg="violet", font=("Arial", 18, "bold"), activebackground="white", activeforeground="white")
    exitbutton = Button(text="EXIT", command=toexit, fg="white", bg="violet", font=("Arial", 18, "bold"), activebackground="white", activeforeground="white")
